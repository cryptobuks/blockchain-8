Crowcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/crowcoin/files/Crowcoin/crowcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Crowcoin
...
New/changed settings (command-line or crowcoin.conf file)
--------------------------------------------------------
