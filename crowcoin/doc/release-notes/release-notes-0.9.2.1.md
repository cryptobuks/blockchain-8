Crowcoin Core version 0.9.2.1 is now available from:

  https://crowcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GCC to 0.01 GCC
...
- Fix "Start crowcoin on system login"
