Download URL: https://sourceforge.net/projects/crowcoin/files/Crowcoin/crowcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 GCC fee schedule (users still pay 0.01 GCC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #crowcoin00 - #crowcoin99
