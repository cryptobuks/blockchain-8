Crowcoin Core version 0.9.4 is now available from:

  https://crowcoin.org/bin/0.9.4/
...
this update is incompatible with the Crowcoin system and could lead to consensus
forks.

Crowcoin Core released binaries from https://crowcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~crowcoin/+archive/ubuntu/crowcoin
- A third-party or self-compiled Crowcoin Core

upgrade to Crowcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
