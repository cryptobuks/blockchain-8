Crowcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/crowcoin/files/Crowcoin/crowcoin-0.5.4/
...
http://gitorious.org/crowcoin/crowcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Crowcoin-Qt notifications under Growl 1.3.
Increase required age of Crowcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCrowcoin properly when installing Crowcoin-Qt over it. (Windows)
