...
// Copyright (c) 2009-2012 The Crowcoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Crowcoin/$1-%s The Crowcoin/' %s"
REGEX_CURRENT= re.compile("%s The Crowcoin" % year)
