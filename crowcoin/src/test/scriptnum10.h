...
#ifndef CROWCOIN_TEST_SCRIPTNUM10_H
#define CROWCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Crowcoin Core 0.10.0, for cross-comparison.
 */
public:
