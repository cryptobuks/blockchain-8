...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/crowcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Crowcoin Core"),
     ...
     * override -datadir in the crowcoin.conf file in the default data directory
     * (to be consistent with crowcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
