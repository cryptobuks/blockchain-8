...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000000d2feec4049fca2595bd6f04bf86988c4b4cc355f18625972a393b709"));
        assert(genesis.hashMerkleRoot == uint256S("0x5e0a6e24146fd44d4d292702345430d0f9da69e4f2b0103b5c1cf7950e3bd75a"));

        //vSeeds.push_back(CDNSSeedData("crowcoin.sipa.be", "seed.crowcoin.sipa.be")); // Pieter Wuille
        //vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me")); // Matt Corallo
        //vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.crowcoin.dashjr.org")); // Luke Dashjr
        //vSeeds.push_back(CDNSSeedData("crowcoinstats.com", "seed.crowcoinstats.com")); // Christian Decker
        //vSeeds.push_back(CDNSSeedData("xf2.org", "bitseed.xf2.org")); // Jeff Garzik
        //vSeeds.push_back(CDNSSeedData("crowcoin.jonasschnelli.ch", "seed.crowcoin.jonasschnelli.ch")); // Jonas Schnelli

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0); // 公钥地址前缀：https://en.crowcoin.it/wiki/List_of_address_prefixes（这里 0 对应 1）
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x00000000d2feec4049fca2595bd6f04bf86988c4b4cc355f18625972a393b709")),
				1519978516, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("crowcoin.petertodd.org", "testnet-seed.crowcoin.petertodd.org"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "testnet-seed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("crowcoin.schildbach.de", "testnet-seed.crowcoin.schildbach.de"));
...
public:
    CRegTestParams() {
        ...
        //assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        assert(consensus.hashGenesisBlock == uint256S("0x4363624044710f624cc1fe4f17c4136b73c890369767cb8aa84b34b078371056"));
        assert(genesis.hashMerkleRoot == uint256S("0x5e0a6e24146fd44d4d292702345430d0f9da69e4f2b0103b5c1cf7950e3bd75a"));
