...
unlocked to sign the Crowcoin-Qt.app bundle.
...
allowing somebody to distribute a Crowcoin-Qt.app or crowcoin-qt-setup.exe with a valid
...
that the crowcoin-qt.exe file inside the installer had not been tampered with.
