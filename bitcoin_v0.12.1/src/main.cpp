...
{
    uint64_t nFreeBytesAvailable = boost::filesystem::space(GetDataDir()).available; // ��ȡָ������Ŀ¼��ǰ����Ӳ�̿ռ䣬��λ B

    // Check for nMinDiskSpace bytes (currently 50MB)
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes) // ��ǰӲ�̿ռ䲻�ܵ��� 50MB
